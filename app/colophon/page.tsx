...
const THEMES_INFO = [
  ...
  },
  {
    id: "charcoal",
    name: "Charcoal (Dark)",
    desc: "Warm dark charcoal (#151517) canvas with refined dark zinc surfaces (#1c1c1f), crisp ink (#ecebe9), and periwinkle focus ring.",
    bg: "#151517",
    surface: "#1c1c1f",
    ink: "#ecebe9",
    accent: "#8aa2ff",
  },
  {
    ...
    desc: "Deep ink-navy canvas (#0a0f1a) with midnight slate surface (#121a2a) and soft periwinkle accent.",
    bg: "#0a0f1a",
    surface: "#121a2a",
    ink: "#e8edf7",
    accent: "#8aa2ff",
