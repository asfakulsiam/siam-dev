...
- Name: admin-crud.spec.ts >> Admin CRUD & Content Management >> upload a meme asset and set it active in /admin/appearance
- Location: tests/e2e/admin-crud.spec.ts:173:7
